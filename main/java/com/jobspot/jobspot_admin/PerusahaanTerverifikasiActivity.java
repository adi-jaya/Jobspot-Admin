...
public class PerusahaanTerverifikasiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perusahaan_terverifikasi);

        recyclerView = findViewById(R.id.recyclerView);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(PerusahaanTerverifikasiActivity.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);
        perusahaanRecyclerViewModelList = new ArrayList<>();

        String[] namaPerusahaanList = {"Lorem Group Inc.", "Ipsum Group Inc."};
        String[] dokumenPerusahaanList = {"Lorem Group Inc. Doc.pdf", "Ipsum Group Inc. Doc.pdf"};
        ...
        String statusPerusahaan = "Terverifikasi";
        ...
        perusahaanRecyclerViewAdapter = new PerusahaanRecyclerViewAdapter(PerusahaanTerverifikasiActivity.this, perusahaanRecyclerViewModelList);
